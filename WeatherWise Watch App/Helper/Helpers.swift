...
let nepalCities = ["Kathmandu", "Pokhara", "Biratnagar", "Bharatpur", "Birgunj", "Dharan", "Nepalgunj", "Hetauda", "Bhaktapur", "Dhangadhi", "Bhimdatta", "Butwal", "Birendranagar", "Itahari", "Janakpur", "Dhankuta", "Siddharthanagar"]
...
func getWeatherBackgroundColor(code: Int) -> Color {
